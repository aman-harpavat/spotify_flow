...
export function Sidebar() {
  return (
    <aside className="hidden w-[118px] shrink-0 md:block">
      <div className="fixed left-2 top-2 z-20 flex h-[calc(100vh-8.5rem)] w-[118px] flex-col rounded-[12px] bg-black px-3 py-4">
